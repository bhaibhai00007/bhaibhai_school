...
<main>
    <div class="main-content">
        ...
        <div class="col s12">
            <h4 class="main-text lighten-1">Manage parent</h4>
            <ul class="tabs tab-demo z-depth-1">
                <li class="tab col s3"><a class="active" href="#ParentsList">Parents List</a></li>
                <li class="tab col s3"><a  href="#ParentAdd">Add Parent</a></li>
            </ul>
            <div id="ParentsList" class="col s12">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <table class="datatable bordered">
                                    ...
                                    <!-- <?php //print_r($parentDataArr);?> -->
                                        <?php if (!empty($parentDataArr)): $slNo=0;
                                            foreach ($parentDataArr AS $key =>$value): //pre($value);?>
                                        <tr>
                                            <td class="center-align" width="10%">
                                                <input type="checkbox" id="parent<?php echo $value['parentId'];?>">
                                                <label for="parent<?php echo $value['parentId'];?>"><?php echo ++$slNo;?></label>
                                            </td>
                                            <td data-id="<?php echo $value['parentId'];?>" width="20%"><?php echo $value['fName'].' '.$value['lName'];?></td>
                                            <td width="25%"><?php echo $value['communicationEmail'];?></td>
                                            <td width="15%"><?php echo $value['motherFName'].''.$value['motherLName'];?></td>
                                            ...
                                            <td class="center-align" width="20%">
                                                <div class="btn-group">
                                                    <a href="javascript:void(0);" class="btn-flat btn-small waves-effect">
                                                        <i class="material-icons material-icons-edit" data-editid="<?php echo $value['parentId'];?>">edit</i>
                                                    </a>
                                                    <a href="javascript:void(0);" class="btn-flat btn-small waves-effect">
                                                        <?php if($value['status']==1):?>
                                                        <i style="font-size:0.8rem !important;" class="make-inactive-cl" data-statusid="<?php echo $value['parentId'];?>" title="Active">Make Inactive</i>
                                                        <?php else:?>
                                                        <i style="font-size:0.8rem !important;" class="make-active-cl" data-statusid="<?php echo $value['parentId'];?>" title="Inactive">Make Active</i>
                                                        <?php endif;?>
                                                    </a>
            ...
            <div id="ParentAdd" class="col s12">
            <?php echo form_open_multipart('#',array('id'=>'erp_parent_add_form','class'=>'form-vertical'));?>
                    <div class="row">
                            ...
                            <div class="panel panel-bordered">
                                ...
                                <div class="panel-body">
                                    <div class="row no-gutter">
                                        ...
                                        <?php endforeach;?>
                                        <?php foreach($table_parent_structure_text AS $key=>$val): //pre($key);die;?>
                                ...
                                <div class="panel-footer">
                                    <div class="right-align">
                                        ...
                                        <button type="submit" class="btn-flat waves-effect" id="parentAddSubmit">
                                            SUBMIT
                                        </button>
                                    </div>
                                </div>
...
<?php echo $footer; ?>
<script src="<?php echo SchoolSiteJSURL; ?>custom/<?php echo $this->erpUserTypeArr[$this->userType];?>/parent/parent_list.js" type="text/javascript"></script>
...
<script src="<?php echo SchoolSiteJSURL; ?>custom/<?php echo $this->erpUserTypeArr[$this->userType];?>/parent/parent_form.js" type="text/javascript"></script>
<?php /*
...
<script src="<?php echo SchoolSiteJSURL; ?>custom/<?php echo $this->erpUserTypeArr[$this->userType];?>/parent/parent_manage.js"></script>
...
jQuery(document).ready(function(){
    ...
    myJsMain.parent_add();
    myJsMain.parent_edit();
    myJsMain.parent_update_status();
