...
echo form_open_multipart(BASE_URL . $this->erpUserTypeArr[$this->userType] . '/ajax_controller_principal/edit_parent', array('id' => 'erp_parent_edit_form', 'class' => 'form-vertical'),$hidden); ?>
<div class="row">
...
<script src="<?php echo SchoolSiteJSURL; ?>custom/<?php echo $this->erpUserTypeArr[$this->userType]; ?>/parent/parent_form_edit.js" type="text/javascript"></script>
